    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-left">
                <li class="drop"><a class="home" href="{{ route('index') }}">Home</a>
                    <ul class="dropdown">
                ...
                <li><a class="world" href="{{ route('world') }}">World</a>
                ...
                <li><a class="travel" href="{{ route('travel') }}">Travel</a>
                    <div class="megadropdown">
                        <div class="container">
                ...
                <li><a class="tech" href="{{ route('tech') }}">Tech</a>
                    <div class="megadropdown">
                        <div class="container">
                ...
                <li><a class="fashion" href="{{ route('fashion') }}">Fashion</a></li>

                <li><a class="video" href="{{ route('video') }}">Video</a>
                    <div class="megadropdown">
                        <div class="container">
                ...
                <li><a class="sport" href="{{ route('sport') }}">Sport</a></li>
                <li><a class="food" href="{{ route('food') }}">Food &amp; Health</a></li>
